...
export type ToolRuntime =
  ...
  | "system"
  // Uses a system executable when present, otherwise an Coodi-managed binary.
  | "binary";
type ExtensionKind = "ui" | "workspace" | "web";

export interface ExtensionManifest {
  // Core metadata
  id: string; // Unique identifier (e.g., "coodi.rust")
  ...
  // Runtime capability metadata used by Coodi extension packages before they
