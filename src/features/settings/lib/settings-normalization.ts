...
function normalizeIconTheme(value: string): string {
  if (
    value === "coodi-icons-dimmed" ||
    value === "coodi-icons-light" ||
    value === "coodi-file-icons" ||
    value === "coodi-file-icons-dark" ||
    value === "coodi-file-icons-light"
  ) {
    return "coodi-icons";
  }
...
export function normalizeSettings(settings: Settings): Settings {
  ...
  delete (normalizedSettings.coreFeatures as { coodiEditorEngine?: unknown }).coodiEditorEngine;
