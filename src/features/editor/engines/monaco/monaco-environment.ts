...
declare global {
  interface Window {
    ...
    __coodiMonacoContextMenuInitialized?: boolean;
    __coodiMonacoExternalLinkOpenerInitialized?: boolean;
  }
}

if (typeof window !== "undefined") {
  if (!window.__coodiMonacoExternalLinkOpenerInitialized) {
    window.__coodiMonacoExternalLinkOpenerInitialized = true;
  ...
  if (!window.__coodiMonacoContextMenuInitialized) {
    window.__coodiMonacoContextMenuInitialized = true;
