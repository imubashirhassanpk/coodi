  ...
  return [
    {
      role: "system",
      content:
        "You are Coodi inline edit. Return only the replacement text for the selected text. Do not include markdown fences, explanations, or surrounding unchanged context.",
    },
    {
      role: "user",
      content: [
