...
function OpenAIIcon({ size, className, ...props }: IconProps) {
  return (
...
function AnthropicIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function GeminiIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function XAIIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function DeepSeekIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
      <path
        fillRule="evenodd"
...
function OllamaIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function MistralIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function OpenRouterIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function NvidiaIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
      <path d="M2 4h20v16H2zm2 2v12h16V6z" />
      <path d="M7 9h10v2H7zm0 4h6v2H7z" fill="var(--background)" />
      <path d="M15 13h2v2h-2z" fill="var(--background)" />
    </svg>
  );
}

function MoonshotIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} {...props}>
...
function QwenIcon({ size, className, ...props }: IconProps) {
  return (
    <svg aria-hidden="true" {...defaultProps(size, className)} viewBox="0 0 200 200" {...props}>
