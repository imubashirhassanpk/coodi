...
const BREAKPOINTS_STORAGE_KEY = "coodi-debugger-breakpoints";
const USER_CONFIGS_STORAGE_KEY = "coodi-debugger-user-configs";
const WATCH_EXPRESSIONS_STORAGE_KEY = "coodi-debugger-watch-expressions";
