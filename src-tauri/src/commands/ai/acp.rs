...
use coodi_ai::{AcpAgentBridge, AcpAgentStatus, AcpSessionList, AgentConfig, AgentRuntime};
use coodi_runtime::{RuntimeManager, RuntimeType};
use coodi_tooling::{ToolConfig, ToolInstaller, ToolRuntime};
...
fn extensions_manifest_url() -> String {
   let base_url = std::env::var("COODI_EXTENSIONS_CDN_URL")
