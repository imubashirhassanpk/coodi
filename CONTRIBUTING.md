# Contributing to Coodi

Thank you for contributing to Coodi! Please check existing issues and pull requests before creating new ones.

## Setup

See [setup guides](https://www.mubashirhassan.com/coodi/docs/contributing) for your platform.
